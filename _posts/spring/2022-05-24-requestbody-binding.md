---
title: '[Spring] @RequestBody 바인딩 여행기'
author: meatsby
...
![Screen Shot 2022-05-23 at 1.12.00 AM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-23_at_1.12.00_AM.png)
...
![Screen Shot 2022-05-24 at 1.50.57 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_1.50.57_PM.png)

`@ResponseBody` 의 바인딩 처리 수행 시 위 메서드가 호출된다.

### `AbstractMessageConverterMethodArgumentResolver.java`

![Screen Shot 2022-05-24 at 1.52.52 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_1.52.52_PM.png)
...
![Screen Shot 2022-05-24 at 1.56.46 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_1.56.46_PM.png)
...
![Screen Shot 2022-05-24 at 3.30.35 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_3.30.35_PM.png)

![Screen Shot 2022-05-24 at 3.28.40 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_3.28.40_PM.png)
...
![Screen Shot 2022-05-24 at 3.40.08 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_3.40.08_PM.png)

전달받은 `BeanDeserializer` 의 `deserialize()` 로 JSON → Java Object 역직렬화를 수행한다.

### `BeanDeserializer.java`

![Screen Shot 2022-05-24 at 3.47.05 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_3.47.05_PM.png)
...
![Screen Shot 2022-05-24 at 3.53.33 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_3.53.33_PM.png)

`deserializeFromObject()` 내부를 확인하면 `createUsingDefault()` 를 호출하는 것을 알 수 있다.

### `StdValueInstantiator.java`

![Screen Shot 2022-05-24 at 3.56.18 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_3.56.18_PM.png)

`createUsingDefault()` 내부에서 객체의 기본생성자인 `_defaultCreator.call()` 를 호출한다.

### `AnnotatedConstructor.java`

![Screen Shot 2022-05-24 at 4.02.04 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_4.02.04_PM.png)

`call()` 메서드 내부를 살펴보면 Java Reflection API 의 Constructor 클래스인 `_constructor` 의 `newInstance()` 메서드를 호출한다.

### `Constructor.java`

![Screen Shot 2022-05-24 at 4.04.16 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_4.04.16_PM.png)
...
![Screen Shot 2022-05-24 at 4.10.34 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_4.10.34_PM.png)

`BeanDeserializer.java` 의 `_nonStandardCreation` 분기에 걸려 `deserializeFromObjectUsingNonDefault()` 메서드로 객체 생성을 시도한다.

### `BeanDeserializerBase.java`

![Screen Shot 2022-05-24 at 4.13.41 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_4.13.41_PM.png)
...
![Screen Shot 2022-05-24 at 4.44.41 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_4.44.41_PM.png)

`buildBeanDeserializer()` 메서드 내부에서 `addBeanProps()` 를 통해 `getter` 와 `setter` 로 Bean Property 를 찾는 과정을 수행한다.

### `BeanDeserializer.java`

![Screen Shot 2022-05-24 at 5.04.28 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_5.04.28_PM.png)
...
![Screen Shot 2022-05-24 at 5.07.58 PM.png](/assets/img/2022-05-24-requestbody-binding/Screen_Shot_2022-05-24_at_5.07.58_PM.png)
