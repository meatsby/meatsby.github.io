...
운영 사례 = [[10. AL2023 EKS Worker AMI Migration#OS 튜닝 (sysctl·limits)]] — AMI 빌드 시 `net.core.rmem_max=26214400` 박은 배경.
...
- [[10. AL2023 EKS Worker AMI Migration#OS 튜닝 (sysctl·limits)]]
