---
title: 09. AL2023 EKS Worker AMI Migration
...
- BDP (대역 × RTT) 가 큰 AWS 환경 (cross-AZ·cross-region·S3·EBS 대용량 IO) 에서 TCP throughput 향상.
- 자세히 = [[07. Linux Networking#rmem_max·tcp_rmem — TCP buffer 튜닝]].
